class DeCraftSK_Shelves_Cans extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SK_Shelves_Cans");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SK_Shelves_Cans_Kit");//add results here
