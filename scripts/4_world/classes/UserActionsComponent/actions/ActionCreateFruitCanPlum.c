class ActionCreateFruitCanPlum : ActionInteractBase
{
    void ActionCreateFruitCanPlum()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "Plum") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredFruit("Plum");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CanPlum");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_powidel_sliwkowych"); // np. #PuszkaZJablkiem
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_powidel_sliwkowych"; }
}