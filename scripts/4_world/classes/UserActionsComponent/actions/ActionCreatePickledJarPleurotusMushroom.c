class ActionCreatePickledJarPleurotusMushroom : ActionInteractBase
{
    void ActionCreatePickledJarPumpkin()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "PleurotusMushroom") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("PleurotusMushroom");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Boczniaki_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_Boczniaki_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_Boczniaki_w_occie"; }
}