class ActionCreateMeatCanGoat  : ActionInteractBase
{
    void ActionCreateMeatCanGoat ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "GoatSteakMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("GoatSteakMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatGoat"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_kozy");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_kozy"; }
}