class ActionCreatePickledJarPumpkin : ActionInteractBase
{
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("SlicedPumpkin");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_PumpkinMarynata_Jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_dynia_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_dynia_w_occie"; }
}