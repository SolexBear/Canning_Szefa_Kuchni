class ActionCreateMeatCanMackerel  : ActionInteractBase
{
    void ActionCreateMeatCanMackerel ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "MackerelFilletMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("MackerelFilletMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatMackerel"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_Makreli");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_Makreli"; }
}