class ActionCreatePickledJarAgaricusMushroom : ActionInteractBase
{
    void ActionCreatePickledJarAgaricusMushroom ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "AgaricusMushroom") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("AgaricusMushroom");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Pieczarki_Jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_pieczarka_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_pieczarka_w_occie"; }
}