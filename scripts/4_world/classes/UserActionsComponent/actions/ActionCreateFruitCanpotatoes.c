class ActionCreateFruitCanpotatoes : ActionInteractBase
{
    void ActionCreateFruitCanpotatoes()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "Potato") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredFruit("Potato");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CanPotato");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszka_puree_ziemniaczanego"); // np. #PuszkaZJablkiem
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszka_puree_ziemniaczanego"; }
}