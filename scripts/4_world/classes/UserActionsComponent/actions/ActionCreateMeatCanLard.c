class ActionCreateMeatCanLard  : ActionInteractBase
{
    void ActionCreateMeatCanLard ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "Lard") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("Lard");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatLard"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_sloniny");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszka_sloniny"; }
}