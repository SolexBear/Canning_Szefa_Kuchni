class ActionCreatePickledJarBoletusMushroom : ActionInteractBase
{
    void ActionCreatePickledJarBoletusMushroom ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "BoletusMushroom") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("BoletusMushroom");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Borowik_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_Borowiki_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_Borowiki_w_occie"; }
}