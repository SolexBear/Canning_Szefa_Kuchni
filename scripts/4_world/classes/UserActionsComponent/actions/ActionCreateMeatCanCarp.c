class ActionCreateMeatCanCarp  : ActionInteractBase
{
    void ActionCreateMeatCanCarp ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "CarpFilletMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("CarpFilletMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatCarp"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_karpia");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszka_Karpia"; }
}