class ActionCreateMeatCanReindeer  : ActionInteractBase
{
    void ActionCreateMeatCanReindeer ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "ReindeerSteakMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("ReindeerSteakMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatReindeer"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_Renifera");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_Renifera"; }
}