class ActionCreateJamJarPear : ActionInteractBase
{
    void ActionCreateJamJarPear()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        float required = SzefKuchni_Config.GetRequiredJam("Pear");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_pear_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_dzem_gruszkowy");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_dzem_gruszkowy"; }
}