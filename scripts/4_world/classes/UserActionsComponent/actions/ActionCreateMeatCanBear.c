class ActionCreateMeatCanBear : ActionInteractBase
{
    void ActionCreateMeatCanBear()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "BearSteakMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("BearSteakMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatBear"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_z_niedzwiedzia");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_z_niedzwiedzia"; }
}