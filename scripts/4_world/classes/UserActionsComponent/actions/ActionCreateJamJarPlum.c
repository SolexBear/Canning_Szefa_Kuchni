class ActionCreateJamJarPlum : ActionInteractBase
{
    void ActionCreateJamJarPlum()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        float required = SzefKuchni_Config.GetRequiredJam("Plum");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Plum_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_marmolade_sliwkowa");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_marmolade_sliwkowa"; }
}