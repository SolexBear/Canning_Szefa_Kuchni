class ActionCreatePickledJarPeppers : ActionInteractBase
{
    void ActionCreatePickledJarPeppers()
    {
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Peppers_Jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_sloik_papryka_w_occie");
    }
