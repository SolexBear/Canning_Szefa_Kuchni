class ActionCreateMeatCanWolf : ActionInteractBase
{
    void ActionCreateMeatCanWolf()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "WolfSteakMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("WolfSteakMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatWolf"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_z_Wilka");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_z_Wilka"; }
}