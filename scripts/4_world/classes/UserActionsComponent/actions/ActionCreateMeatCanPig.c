class ActionCreateMeatCanPig  : ActionInteractBase
{
    void ActionCreateMeatCanPig ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "PigSteakMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("PigSteakMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatPig"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_Wieprzowiny");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_Wieprzowiny"; }
}