class ActionCreateJamJarCaninaBerry : ActionInteractBase
{
    void ActionCreateJamJarCaninaBerry()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "CaninaBerry") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredJam("CaninaBerry");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CaninaBerry_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_konfiture_dzika_roza");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_konfiture_dzika_roza"; }
}