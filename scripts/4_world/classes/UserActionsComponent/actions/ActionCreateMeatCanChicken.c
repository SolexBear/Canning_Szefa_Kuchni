class ActionCreateMeatCanChicken  : ActionInteractBase
{
    void ActionCreateMeatCanChicken ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "ChickenBreastMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("ChickenBreastMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatChicken"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszka_drobiowa");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszka_drobiowa"; }
}