class ActionCreatePickledJarPear : ActionInteractBase
{
    void ActionCreatePickledJarPear()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("Pear");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_PearMarynata_Jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_gruszka_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_gruszka_w_occie"; }
}