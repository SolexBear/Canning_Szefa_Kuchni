class ActionCreateMeatCanCow  : ActionInteractBase
{
    void ActionCreateMeatCanCow ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "CowSteakMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("CowSteakMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatCow"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_Wolowiny");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_Wolowiny"; }
}