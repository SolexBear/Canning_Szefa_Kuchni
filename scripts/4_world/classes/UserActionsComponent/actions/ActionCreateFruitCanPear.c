class ActionCreateFruitCanPear : ActionInteractBase
{
    void ActionCreateFruitCanPear()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "Pear") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredFruit("Pear");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CanPear");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszka_musu_gruszkowego"); // np. #PuszkaZJablkiem
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszka_musu_gruszkowego"; }
}