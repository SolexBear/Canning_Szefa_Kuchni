class ActionCreateMeatCanTrout  : ActionInteractBase
{
    void ActionCreateMeatCanTrout ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "SteelheadTroutFilletMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("SteelheadTroutFilletMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatTrout"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_z_Trout");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_z_Trout"; }
}