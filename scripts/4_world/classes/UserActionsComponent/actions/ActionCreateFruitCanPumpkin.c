class ActionCreateFruitCanPumpkin : ActionInteractBase
{
    void ActionCreateFruitCanPumpkin()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        if (!canIngredient || canIngredient.GetType() != "SzefFood_CanSugar")
            return false;
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "SlicedPumpkin") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredFruit("SlicedPumpkin");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CanPumpkin");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_puszke_musu_dyniowego"); // np. #PuszkaZJablkiem
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_musu_dyniowego"; }
}