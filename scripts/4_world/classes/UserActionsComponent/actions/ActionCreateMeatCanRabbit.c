class ActionCreateMeatCanRabbit  : ActionInteractBase
{
    void ActionCreateMeatCanRabbit ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "RabbitLegMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("RabbitLegMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatRabbit"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_Krolika");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_Krolika"; }
}