class ActionCreateJamJarApple : ActionInteractBase
{
    void ActionCreateJamJarApple()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        float required = SzefKuchni_Config.GetRequiredJam("Apple");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Apple_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_dzem_jablkowy");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_dzem_jablkowy"; }
}