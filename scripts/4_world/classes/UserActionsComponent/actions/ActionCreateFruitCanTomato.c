class ActionCreateFruitCanTomato : ActionInteractBase
{
    void ActionCreateFruitCanTomato()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "Tomato") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredFruit("Tomato");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CanTomatoes");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_przecieru_pomidorowego"); // np. #PuszkaZJablkiem
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_przecieru_pomidorowego"; }
}