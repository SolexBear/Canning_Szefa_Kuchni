class ActionCreatePickledJarLactariusMushroom : ActionInteractBase
{
    void ActionCreatePickledJarLactariusMushroom()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "LactariusMushroom") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("LactariusMushroom");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Rydz_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_Rydza_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_Rydza_w_occie"; }
}