class ActionCreateJamJarPumpkin : ActionInteractBase
{
    void ActionCreateJamJarPumpkin()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        float required = SzefKuchni_Config.GetRequiredJam("SlicedPumpkin");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Pumpkin_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_dzem_dyniowy");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_dzem_dyniowy"; }
}