class ActionCreateJamJarSambucusBerry : ActionInteractBase
{
    void ActionCreateJamJarSambucusBerry()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        if (!jarIngredient || jarIngredient.GetType() != "SzefFood_Sugar_Jar")
            return false;
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "SambucusBerry") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredJam("SambucusBerry");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_SambucusBerry_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_konfiture_czarny_bez");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_konfiture_czarny_bez"; }
}