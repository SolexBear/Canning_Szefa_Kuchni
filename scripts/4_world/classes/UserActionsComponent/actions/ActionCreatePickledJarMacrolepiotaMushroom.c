class ActionCreatePickledJarMacrolepiotaMushroom : ActionInteractBase
{
    void ActionCreatePickledJarMacrolepiotaMushroom()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "MacrolepiotaMushroom") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("MacrolepiotaMushroom");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_Kania_jar");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_Kania_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_Kania_w_occie"; }
}