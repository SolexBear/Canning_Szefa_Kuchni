class ActionCreateFruitCanApple : ActionInteractBase
{
    void ActionCreateFruitCanApple()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "Apple") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredFruit("Apple");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CanApple");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszka_musu_jablkowego"); // np. #PuszkaZJablkiem
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszka_musu_jablkowego"; }
}