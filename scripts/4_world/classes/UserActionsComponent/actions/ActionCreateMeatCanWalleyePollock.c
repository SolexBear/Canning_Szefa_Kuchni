class ActionCreateMeatCanWalleyePollock  : ActionInteractBase
{
    void ActionCreateMeatCanWalleyePollock ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "WalleyePollockFilletMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("WalleyePollockFilletMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatWalleyePollock"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_z_Mintaja");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_z_Mintaja"; }
}