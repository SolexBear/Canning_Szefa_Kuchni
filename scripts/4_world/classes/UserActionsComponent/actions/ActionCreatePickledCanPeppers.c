class ActionCreatePickledCanPeppers : ActionInteractBase
{
    void ActionCreatePickledCanPeppers()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        if (!canIngredient || canIngredient.GetType() != "SzefFood_CanOcet")
            return false;
        ...
        foreach (ItemBase ingredient : ingredients)
        {
            ...
            if (ingredient.GetType() != "GreenBellPepper") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredPickle("GreenBellPepper");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_CanPepper");
        SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_papryka_w_occie");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_papryka_w_occie"; }
}