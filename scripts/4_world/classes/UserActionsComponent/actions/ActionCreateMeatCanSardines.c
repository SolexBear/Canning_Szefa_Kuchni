class ActionCreateMeatCanSardines  : ActionInteractBase
{
    void ActionCreateMeatCanSardines ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "Sardines") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("Sardines");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatSardines"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_Sardynek");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_Sardynek"; }
}