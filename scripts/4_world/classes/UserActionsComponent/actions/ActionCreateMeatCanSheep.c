class ActionCreateMeatCanSheep  : ActionInteractBase
{
    void ActionCreateMeatCanSheep ()
    {
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        {
            if (!meat) continue;
            if (meat.GetType() != "SheepSteakMeat") return false;
        ...
        float required = SzefKuchni_Config.GetRequiredMeat("SheepSteakMeat");
    ...
    override void OnStartServer(ActionData action_data)
    {
        ...
        SzefKuchni_Utils.SpawnOnTable(table, "SzefFood_MeatSheep"); // <-- ZMIEŃ NAZWĘ PRODUKTU
		SzefKuchni_Utils.SendChatMessage(action_data.m_Player, "#Stworzyles_puszke_baraniny");
    }

    override bool HasTarget() { return true; }
    override string GetText() { return "#Wytworz_puszke_baraniny"; }
}