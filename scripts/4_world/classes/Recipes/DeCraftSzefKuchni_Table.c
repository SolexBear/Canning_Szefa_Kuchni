class  DeCraftSzefKuchni_Table extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SzefKuchni_Table");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SzefKuchni_Table_Kit");//add results here
